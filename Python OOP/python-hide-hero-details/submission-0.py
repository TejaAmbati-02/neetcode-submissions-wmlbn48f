class SuperHero:
    ...
    def set_health(self, new_health):
        if new_health > 100:
            print("You can't set the health to more than 10")
        elif new_health <= 0:
...
power_power_level = super_hero.get_power_level()
print(f"{hero_name} has {hero_health} health and {power_power_level} power level.")
